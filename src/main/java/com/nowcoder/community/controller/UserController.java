...
public class UserController implements CommunityConstant {
    ...
    public String updatePassword(String oldPassword, String newPassword,  String confirmPassword, Model model){
        ...
        if (!newPassword.equals(confirmPassword )) {
            model.addAttribute("error3", "两次输入的密码不相同!");
            return "/site/setting";
        }
    ...
    public String getMyPosts(@PathVariable("userId") int userId, Page page, Model model,
        ...
        page.setRows((int) userService.findMyPostCount(userId, ENTITY_TYPE_POST));
    ...
    public String getMyReplies(@PathVariable("userId") int userId, Page page, Model model) {
        ...
        page.setRows((int) userService.findMyReplyCount(userId, ENTITY_TYPE_POST));
        // 回复列表
        //List<Comment> replyList = commentService.findCommentsById(
                //ENTITY_TYPE_COMMENT, userId, 0, Integer.MAX_VALUE);


        List<Comment> list = commentService.findComments(ENTITY_TYPE_POST, userId, page.getOffset(), page.getLimit());
